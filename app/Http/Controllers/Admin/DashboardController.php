...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $response = Http::get('https://ionfirm.com/whatscloud/update', [
        'version' => $version
    ]);
    ...
    //dd($update);
        return view('admin.dashboard', compact('update'));
    }
    ...
    public function dashboardData()
    {
        ...
        $data['junk_conversation']     = ChatMessage::where('updated_at', '<', $subdays)->count();
