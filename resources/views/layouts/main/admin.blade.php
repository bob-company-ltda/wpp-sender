...
<ul class="navbar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link {{ Request::is('admin/wallet*') ? 'active' : '' }}" href="{{ route('admin.wallet.index') }}">
     <i class="fi fi-rs-wallet"></i>
      <span class="nav-link-text">{{ __('Credit & Wallet') }}</span>
    </a>
  </li>
  @endif
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" href="{{ route('admin.addons.index') }}">
      ...
      <span class="nav-link-text">{{ __('Plugins') }}</span>
      <span style="font-size:8px;" class="badge badge-warning">{{__('Addon') }}</span>
    </a>
  </li>
</ul>
...
<ul class="navbar-nav">
  <li class="nav-item">
    <a class="nav-link {{ Request::is('admin/cloudapis*') ? 'active' : '' }}" href="{{ route('admin.cloudapis.index') }}">
      ...
      <span class="nav-link-text">{{ __('WhatsApp APIs') }}</span>
    </a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
   ...
   <li class="nav-item">
    ...
    <div class="collapse" id="dev-settings">
      <ul class="nav nav-sm flex-column">
        ...
        @if(isset($pluginConfigs['embedded_signup']) && $pluginConfigs['embedded_signup']['status'] === 1)
        <li class="nav-item">
          <a href="{{ route('admin.developer-settings.show','embedded-signup') }}" class="nav-link">{{ __('Embedded Signup') }}</a>
        </li>
       @endif
       <!--WHATSAPP WEB---->
        @if(isset($pluginConfigs['whatsapp_web']) && $pluginConfigs['whatsapp_web']['status'] === 1)
        <li class="nav-item">
          <a href="{{ route('admin.developer-settings.show','whatsapp-web') }}" class="nav-link">{{ __('WhatsApp Web Server') }}</a>
        </li>
        @endif
        <!---WHATSAPP WEB ---->
   ...
   <li class="nav-item">
    <a class="nav-link" href="{{ route('admin.update.index') }}">
      ...
      <span style="font-size:8px;" class="badge badge-danger">{{__('..') }}</span>
    </a>
  </li>
