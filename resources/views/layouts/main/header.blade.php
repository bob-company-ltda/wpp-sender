<!--p style="color: white; position: absolute; width: 100%; text-align: center; background: #00000036;z-index: 9999999;">In the demo, send messages to our designated no. only. Your No. must be added to our Test API to work.</p-->
<!--p style="position: absolute; z-index: 999; left: 5%; padding: 10px; background: black; border-radius: 10px; color: white;">Purchase before 30 April and Get 15% Additional Discount Using Coupon Code <b>ION24WACL</b> <a style="color:yellow" href="https://ionfirm.com/product/whatscloud-saas-platform-official-whatsapp-api-integration/" target="_blank">Click Here</a> </p-->
